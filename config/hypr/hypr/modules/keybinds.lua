...
-- HELPER: GET TOP MONITOR BRIGHTNESS
...
hl.bind("ALT + SHIFT + Space", hl.dsp.exec_cmd(launcher))                         --launch rofi terminal runner
...
--both screen brightness up and down
hl.bind("CTRL + SHIFT + F6", hl.dsp.exec_cmd("sh -c 'brightnessctl --device=intel_backlight s +1% && brightnessctl --device=card1-eDP-2-backlight s +1%'"),   { locked = true, repeating = true })
